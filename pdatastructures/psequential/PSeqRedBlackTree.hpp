#ifndef _PERSISTENT_SEQUENTIAL_RED_BLACK_BST_H_
#define _PERSISTENT_SEQUENTIAL_RED_BLACK_BST_H_
...
public:
     ...
     */
    PSeqRedBlackTree(int numThreads=0){ }
...
#endif   // _PERSISTENT_SEQUENTIAL_RED_BLACK_BST_H_
