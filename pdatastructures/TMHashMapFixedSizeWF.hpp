#ifndef _PTM_FIXED_SIZE_HASH_MAP_WF_H_
#define _PTM_FIXED_SIZE_HASH_MAP_WF_H_
 ...
 * Does capture by copy. Meant to be used in wait-free PTMs.
 *
 */
template<typename K, typename V, typename TM, template <typename> class TMTYPE>
class TMHashMapFixedSizeWF {
...
public:
    ...
    TMHashMapFixedSizeWF(int capa=1000000) {
