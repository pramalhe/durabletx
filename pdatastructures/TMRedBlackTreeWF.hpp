#ifndef _PERSISTENT_TM_RED_BLACK_BST_WF_H_
#define _PERSISTENT_TM_RED_BLACK_BST_WF_H_

#include <cassert>
#include <stdexcept>
#include <algorithm>

#ifndef RBT_COLOR_RED
...
public:
     ...
     */
    TMRedBlackTreeWF(int numThreads=0){ }
