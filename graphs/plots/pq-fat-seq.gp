...
undolog = `cat '../data/castor/pq-fat-undologfc.txt' | tail -1 `
set label sprintf("%d",undolog) at 1.5,1.1 font ",12" rotate by 90

plot \
    newhistogram \
    "Undo" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-seq-undologfc.txt' using ($1/undolog):xtic(1) notitle @pat1, \
    newhistogram \
    "Redo" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-redologfc.txt' using ($1/undolog):xtic(1) notitle @pat2, \
    newhistogram \
    "Rom" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-romlogfc.txt' using ($1/undolog):xtic(1) notitle @pat4, \
    newhistogram \
    "Trin" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-seq-trinfc.txt' using ($1/undolog):xtic(1) notitle @pat6, \
    newhistogram \
    "Quad" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-seq-quadrafc.txt' using ($1/undolog):xtic(1) notitle @pat7, \
    newhistogram \
    "TrinVR" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-seq-trinvrfc.txt' using ($1/undolog):xtic(1) notitle @pat8, \
    newhistogram \
    "QuadVR" font ",14" offset 1,-1, \
    '../data/castor/pq-fat-seq-quadravrfc.txt' using ($1/undolog):xtic(1) notitle @pat9
