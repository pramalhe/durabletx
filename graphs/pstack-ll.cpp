...
#include "pdatastructures/stacks/TMLinkedListStackByRef.hpp"
#include "ptms/ptm.h"
...
#define DATA_FILE "data/pstack-ll-oflf.txt"
...
#elif defined USE_OFLF
            results[it] = bench.pushPop<TMLinkedListStack<uint64_t,poflf::OneFileLF,poflf::tmtype>,                  poflf::OneFileLF>        (cName, numPairs, numRuns);
#elif defined USE_OFWF
