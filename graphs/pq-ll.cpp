...
#define DATA_FILE "data/pq-ll-oflf.txt"
...
#elif defined USE_OFLF
            results[it] = bench.enqDeq<TMLinkedListQueue<uint64_t,poflf::OneFileLF,poflf::tmtype>,                  poflf::OneFileLF>        (cName, numPairs, numRuns);
#elif defined USE_OFWF
